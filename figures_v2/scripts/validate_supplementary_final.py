...
SRC = ROOT / "figures_v2" / "source_data" / "supplementary_final"
...
def main() -> int:
    ...
    old = ROOT / "figures_v2/supplementary/Figure_S3_Movement_Decoding.png"
    ...
    report = ROOT / "figures_v2/previews/supplementary_final_validation.txt"
