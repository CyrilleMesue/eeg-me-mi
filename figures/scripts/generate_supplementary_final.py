...
- Writes to figures/supplementary_final/ with final numbering.

Entry: PYTHONPATH=src python figures/scripts/generate_supplementary_final.py
"""
...
SRC_OLD = ROOT / "figures" / "supplementary"
SRC_DATA = ROOT / "figures" / "source_data" / "supplementary_final"
PREV = ROOT / "figures" / "previews"
V2_TO_UV2 = 1e12
